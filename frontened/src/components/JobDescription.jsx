  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1"> Description: <span className="pl-4 font-normal text-gray-800">Frontened Developer</span></h1>
        <h1 className="font-bold my-1"> Experience: <span className="pl-4 font-normal text-gray-800">2 yrs</span></h1>
        <h1 className="font-bold my-1"> Salary: <span className="pl-4 font-normal text-gray-800">14LPA</span></h1>
